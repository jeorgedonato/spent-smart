...
const Update = ({getCategories, getExpense, setAlert, updateExpense, categories : {categories } ,expense, match}) => {
  ...
  },[getCategories, getExpense, expense]);
    ...
    <>
      <ContentContainer>
        <FlexContainer>
          ...
          <AnchorTag info style={{ width: '50%', textAlign: "right" }} href="/expenses"><i className="fa fa-arrow-left" aria-hidden="true"></i> Go Back</AnchorTag>
        </FlexContainer>
